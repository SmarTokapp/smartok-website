...
var SmarTokI18n = (function () {
    ...
    var translations = {
        en: {
            ...
            'about.text1': 'SmarTok is redefining the short-form video landscape, where AI technology filters purely valuable content and empowers creators to produce remarkable content. Our platform combines cutting-edge machine learning with intuitive design to deliver an unparalleled experience for both creators and viewers.',
            ...
            'footer.tagline': 'A platform for real creators, where AI curates purely valuable content.',
            ...
            'footer.supportSmartok': 'Support SmarTok',
        ...
        es: {
            ...
            'about.text1': 'SmarTok está redefiniendo el panorama de video de formato corto, donde la tecnología de IA filtra contenido puramente valioso y capacita a los creadores para producir contenido excepcional. Nuestra plataforma combina aprendizaje automático de vanguardia con diseño intuitivo para ofrecer una experiencia incomparable tanto para creadores como para espectadores.',
            ...
            'footer.tagline': 'Una plataforma para creadores reales, donde la IA selecciona contenido puramente valioso.',
            ...
            'footer.supportSmartok': 'Apoyar a SmarTok',
        ...
        fr: {
            ...
            'about.text1': "SmarTok redéfinit le paysage des vidéos de format court, où la technologie IA filtre les contenus purement précieux et permet aux créateurs de produire du contenu remarquable. Notre plateforme combine l'apprentissage automatique de pointe avec un design intuitif pour offrir une expérience inégalée aux créateurs et aux spectateurs.",
            ...
            'footer.tagline': "Une plateforme pour de vrais créateurs, où l'IA sélectionne du contenu purement précieux.",
            ...
            'footer.supportSmartok': 'Soutenir SmarTok',
        ...
        de: {
            ...
            'about.text1': 'SmarTok definiert die Kurzvideo-Landschaft neu — hier filtert KI-Technologie rein wertvolle Inhalte und befähigt Creator, bemerkenswerte Inhalte zu produzieren. Unsere Plattform kombiniert modernstes Machine Learning mit intuitivem Design für ein beispielloses Erlebnis für Creator und Zuschauer.',
            ...
            'footer.tagline': 'Eine Plattform für echte Creator, in der KI rein wertvolle Inhalte kuratiert.',
            ...
            'footer.address': 'Tampa, Florida, USA',
            'footer.supportSmartok': 'SmarTok unterstützen',
        ...
        pt: {
            ...
            'footer.tagline': 'Uma plataforma para criadores reais, onde a IA seleciona conteúdo puramente valioso.',
            'footer.platform': 'Plataforma',
            ...
            'footer.supportSmartok': 'Apoiar o SmarTok',
        ...
        it: {
            ...
            'about.text1': "SmarTok sta ridefinendo il panorama dei video di formato corto, dove la tecnologia IA filtra contenuti puramente preziosi e permette ai creator di produrre contenuti notevoli. La nostra piattaforma combina machine learning all'avanguardia con design intuitivo per offrire un'esperienza impareggiabile sia per creator che per spettatori.",
            ...
            'footer.tagline': "Una piattaforma per veri creator, dove l'IA cura contenuti puramente preziosi.",
            ...
            'footer.address': 'Tampa, Florida, USA',
            'footer.supportSmartok': 'Sostieni SmarTok',
        ...
        ja: {
            ...
            'about.text1': 'SmarTokは、AI技術が真に価値のあるコンテンツだけを厳選し、クリエイターが素晴らしいコンテンツを制作できるよう支援することで、ショート動画の風景を再定義しています。最先端の機械学習と直感的なデザインを組み合わせ、クリエイターと視聴者の両方に比類のない体験を提供します。',
            ...
            'footer.tagline': 'AIが真に価値のあるコンテンツだけを厳選する、真のクリエイターのためのプラットフォーム。',
            ...
            'footer.supportSmartok': 'SmarTokを支援',
        ...
        zh: {
            ...
            'about.text1': 'SmarTok正在重新定义短视频领域——AI技术只筛选真正有价值的内容，赋能创作者制作卓越内容。我们的平台将前沿的机器学习与直观设计相结合，为创作者和观众提供无与伦比的体验。',
            ...
            'footer.tagline': '为真正的创作者打造的平台，AI只甄选纯粹有价值的内容。',
            'footer.platform': '平台',
            'footer.features': '功能',
            'footer.showcase': '展示',
            'footer.videos': '最新内容',
            ...
            'footer.supportSmartok': '支持 SmarTok',
            'webapp.exit': '返回网站',
        ...
        ar: {
            ...
            'about.text1': 'تقوم SmarTok بإعادة تعريف مشهد الفيديو القصير، حيث تعمل تقنية الذكاء الاصطناعي على تصفية المحتوى القيّم فحسب وتمكين المبدعين من إنتاج محتوى رائع. تجمع منصتنا بين تعلم الآلة المتطور والتصميم البديهي لتقديم تجربة لا مثيل لها للمبدعين والمشاهدين.',
            ...
            'footer.tagline': 'منصة للمبدعين الحقيقيين، حيث ينتقي الذكاء الاصطناعي المحتوى القيّم فحسب.',
            ...
            'footer.supportSmartok': 'ادعم SmarTok',
        ...
        hi: {
            ...
            'about.text1': 'SmarTok शॉर्ट-फॉर्म वीडियो परिदृश्य को पुनर्परिभाषित कर रहा है, जहाँ AI तकनीक केवल मूल्यवान सामग्री को फ़िल्टर करती है और रचनाकारों को उत्कृष्ट सामग्री बनाने में सक्षम बनाती है। हमारा प्लेटफ़ॉर्म अत्याधुनिक मशीन लर्निंग को सहज डिज़ाइन के साथ जोड़ता है ताकि रचनाकारों और दर्शकों दोनों के लिए एक अद्वितीय अनुभव प्रदान किया जा सके।',
            ...
            'footer.tagline': 'वास्तविक रचनाकारों के लिए एक प्लेटफ़ॉर्म, जहाँ AI केवल मूल्यवान सामग्री को क्यूरेट करता है।',
            ...
            'footer.supportSmartok': 'SmarTok का समर्थन करें',
